...
absurdity. The player never switches tools; upgrades bolt onto the same object (L14, L16, F11).
...
- Held crouch lowers the viewpoint and slows horizontal movement, allowing low tunnels (L26).
