...
|---|---|---|---|
| D03 | What are distinctive finds ultimately for? | First copy to display with duplicates sold / sell-only with snapshot / some other split | User is researching in other games. Principle already fixed: **no keep/sell choice per item**; each type has one fixed purpose |
...
| ID | Question | Current options | Recommendation / note |
|---|---|---|---|
| W01 | Site size | 24×24×32 / 24×24×48 / 32×32×64 / other | Must exceed 100 m depth; 24×24×48 is the working candidate; playtest |
| W04 | Exact material list | 5 / 7 / 9+ families | 7 families proposed; must feel distinct per F12 |
| W10 | Water or bedrock at the open edge? | Water edge / bedrock / mix | Undecided; either way no swimming/flooding; decide with the art pass |
